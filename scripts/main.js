...
function Human(cool){
  this.cool = cool;
  this.pet = function(dogToPet){
    dogToPet.status = "happy";
  };

  this.feed =function(dogToFeed){
    dogToFeed.hungry = false;
  };
}
...
var sadie = new Dog("black", false, "normal");



var moonshine = new Dog("blue-red", true, "normal");
